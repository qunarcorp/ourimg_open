...
//验证活动信息
$activity_info_rs = QActivity_ReleaseManage::getActivityInfo(['eid'=>$eid]);
if( !$activity_info_rs ){
    QActivity_ReleaseManage::display_result(['errorCode'=>203]);
}
//已发布且活动已开始不允许修改
if( $activity_info_rs['begin_time'] <= date("Y-m-d H:i:s") ){
    QActivity_ReleaseManage::display_result(['errorCode'=>204]);
}
...
$insert_rs = QActivity_ReleaseManage::update(['insert_info'=>$insert_info, 'eid'=>$eid]);
if( !$insert_rs ){
